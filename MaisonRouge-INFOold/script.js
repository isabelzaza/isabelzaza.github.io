...
const I18N = {
  fr: {
    ...
    "internet.li6": "Location de films sur Prime : possible <strong>seulement si je suis disponible pour aider</strong>. <a href='tel:+16154952944'>Textez 615 495 2944</a> pour voir si disponible (remboursement requis; sans garantie).",
  ...
  en: {
    ...
    "internet.li6": "Movie rentals on Prime: available <strong>only if I’m available to help</strong>. <a href='tel:+16154952944'>Text 615-495-2944</a> to ask if available (reimbursement required; not guaranteed).",
