...
const I18N = {
  fr: {
    ...
    "nav.regles": "Règles de la maison",
    ...
    "checklist.items.deck": " <input type='checkbox' data-key='deck-bbq' /> <strong>Terrasse</strong> : si vous avez utilisé le BBQ, est-il nettoyé ? Le parasol est-il attaché ?",
    ...
    "apporter.p2": "Si vous souhaitez utiliser la <strong>fontaine/distributrice d'eau</strong>, merci de <strong>remplacer toute nouvelle bouteille</strong> que vous consommez (ramener la vide au IGA pour la consigne et en racheter une).",
    "regles.title": "Règles de la maison",
    "regles.intro": "Merci de respecter nos voisins et de maintenir une atmosphère paisible.",
    "regles.li1": "<strong>Heures calmes</strong> : Pas de musique forte ou de bruit excessif après <strong>22h</strong> (10 PM).",
    "regles.parasol": "Attachez TOUJOURS le parasol de la terrasse en cas de vent et la nuit. S’il s’envole et se brise ou casse une fenêtre, vous en êtes responsable.",
    "regles.li2": "Gardez le volume de la musique et des conversations à un niveau raisonnable, surtout en soirée.",
    "regles.li3": "Les fêtes bruyantes ou rassemblements importants ne sont pas autorisés.",
    "regles.li4": "Si vous utilisez le foyer extérieur ou le BBQ en soirée, merci de garder le bruit au minimum.",
    "regles.li5": "Respectez les espaces privés des voisins et ne pas empiéter sur leurs propriétés.",
    "regles.note": "Le non-respect de ces règles peut entraîner des plaintes des voisins. Merci de votre compréhension et coopération.",
    ...
    "internet.li6": "Location de films sur Prime : possible <strong>seulement si je suis disponible pour aider</strong>. <a href='tel:+16154952944'>Textez 615 495 2944</a> (<em>svp texte</em>) pour voir si disponible (remboursement requis; sans garantie).",
    ...
    "locks.p3": "Pour la porte vers la salle de soleil : <a href='https://www.youtube.com/watch?v=59tMWgIgvu4' target='_blank' rel='noopener'>instructions Fliplock</a>.",
    ...
    "urgences.li6": "Contact — Isabel Gauthier : <a href='tel:+16154952944'>615-495-2944</a> (<em>texte préférable / svp texte</em>) · <a href='mailto:isabel.gauthier@vanderbilt.edu'>isabel.gauthier@vanderbilt.edu</a>",
    ...
    "kayak.hangar": "La porte de la remise sous le deck ne verrouille pas — il suffit de la fermer.",
    ...
    "eau.li2": "Distributrice d'eau (salle d'entrée) : si vous prenez une bouteille, merci de la remplacer (ramener la vide au IGA pour la consigne de 10 $, en acheter une nouvelle et la remettre au même endroit).",
    ...
    "dechets.shovel": "Au besoin, il y a une pelle dans l'abri de poubelles, cadenas 30-08-02.",
  ...
  en: {
    ...
    "checklist.items.deck": " <input type='checkbox' data-key='deck-bbq' /> <strong>Deck</strong>: if you used the BBQ, is it cleaned? Is the umbrella secured?",
    ...
    "apporter.p2": "If you plan to use the <strong>water cooler</strong>, please <strong>replace any new bottle</strong> you use (return the empty for the deposit at IGA and buy a new one).",
    "regles.title": "House rules",
    "regles.intro": "Please respect our neighbors and maintain a peaceful atmosphere.",
    "regles.li1": "<strong>Quiet hours</strong>: No loud music or excessive noise after <strong>10 PM</strong> (22h).",
    "regles.parasol": "ALWAYS secure the patio umbrella if it is windy and at night. If it takes off and is broken or breaks a window, you are responsible.",
    "regles.li2": "Keep music and conversation volumes at a reasonable level, especially in the evening.",
    "regles.li3": "Loud parties or large gatherings are not permitted.",
    "regles.li4": "If using the outdoor fireplace or BBQ in the evening, please keep noise to a minimum.",
    "regles.li5": "Respect neighbors' private spaces and do not trespass on their properties.",
    "regles.note": "Failure to follow these rules may result in neighbor complaints. Thank you for your understanding and cooperation.",
    ...
    "locks.p3": "For the sunroom door: <a href='https://www.youtube.com/watch?v=59tMWgIgvu4' target='_blank' rel='noopener'>Fliplock instructions</a>.",
    ...
    "urgences.li6": "Contact — Isabel Gauthier: <a href='tel:+16154952944'>615-495-2944</a> (<em>please text</em>) · <a href='mailto:isabel.gauthier@vanderbilt.edu'>isabel.gauthier@vanderbilt.edu</a>",
    ...
    "kayak.hangar": "The door for the hangar under the deck does not lock — just close it.",
    ...
    "eau.li2": "Water dispenser (entry): if you use a jug, please replace it (return the empty to IGA for the $10 deposit, buy a new one, and put it back).",
    ...
    "dechets.shovel": "If needed, there is a shovel in the trash shed, padlock code 30-08-02.",
